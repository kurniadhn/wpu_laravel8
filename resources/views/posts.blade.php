...
@section('section')
    ...
    @if ($posts->count()) 
        <div class="mb-3">
            ...
            @else
                <img src="https://source.unsplash.com/1200x400?{{ $posts[0]->category->name }}" class="card-img-top mb-2" alt="{{ $posts[0]->category->name }}">
            @endif
            <div class="card-body text-center mt-2">
                ...
                <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none btn btn-primary mb-5">Read More</a>
            </div>
        </div>
